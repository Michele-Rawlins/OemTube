  ...
  render() {
    ...
    return (
      <div className="products">
         ...
         <div className="company-intro container-fluid article">
...
<Card className="p-2 col-example text-center md-col d-flex col-3 dashCard">
          {/* <CardTitle tag="h4">Distributors</CardTitle> */}
          <CardImg className="cardPic"src={distributor40}  alt="Card image cap" />
          <CardBody>
          <NavLink className="link-title"tag={RRNavLink} to='/distributor'>Distributors</NavLink>
      </CardBody>
      </Card>
      <Card className="p-2 col-example  text-center d-flex col-3 dashCard">
          ...
          <CardBody>
          <NavLink className="link-title" tag={RRNavLink} to='/serpentine-helical-coils'>Serpentine/Helical Coils</NavLink>
      </CardBody>
      </Card>
      <Card className="p-2 col-example  text-center d-flex col-3 dashCard">
          ...
          <CardBody>
          <NavLink className="link-title" tag={RRNavLink} to='/spun-products'>Spun Products</NavLink>
      </CardBody>
      </Card>
      <Card className="p-2 col-example text-center  d-flex col-3 dashCard">
          ...
          <CardBody>
          <NavLink className="link-title" tag={RRNavLink} to='/assembly-braze'>Assembly and Braze</NavLink>
      </CardBody>
      </Card>
      <Card className="p-2 col-example text-center  d-flex col-3 dashCard">
          ...
          <CardBody>
          <NavLink className="link-title" tag={RRNavLink} to='/tube-fabrication'>Tube Fabrication</NavLink>
      </CardBody>
      </Card>
</div>
