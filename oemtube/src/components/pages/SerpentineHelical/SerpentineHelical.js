...
render() {
  ...
  return (
<div className="SerpentineHelicalSections container-fluid d-flex flex-wrap">
  <div className="title text-center d-flex flex wrap">
    <h1 className="title text-center">Serpentine and Helical Coils</h1>
  </div>
<br></br>
...
<img className="p-2 col-example text-center d-flex  serpentine-pic col-3 "src={serpentine} alt ="serpentine"/>
<img className="p-2 col-example text-center d-flex  serpentine-pic col-3 "src={coil}  alt="coil"/>
<img className="p-2 col-example text-center d-flex  serpentine-pic col-3 "src={helical} alt="helical coil"/>
</div>
