  ...
  render() {
    ...
    return (
      <div className="distributorAssembliesSections">
        ...
        <p className="distributorAssemblies" id="distributor-text">Utilizing proprietary brazing and testing processes, we will manufacture leak free distributor assemblies that meet our customer’s specification.  Our process allows for the prefabrication of complex bent distributor tubes.  </p>
